  ...
  Widget _buildNoteButton() {
    ...
    return IconButton(
      ...
      icon: Icon(
        ...
        color: hasNote ? AppColors.gradientStart : AppColors.textTertiary,
        size: 26,
      ),
      style: IconButton.styleFrom(
              ...
              children: [
                Row(
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        _descriptionController.text = tempController.text
                            .trim();
                        setState(() {});
